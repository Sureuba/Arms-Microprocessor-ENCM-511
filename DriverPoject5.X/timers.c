...
void delay_ms(int time_ms){
   //T2CON config
    T2CONbits.T32 = 0;
    T2CONbits.TCS = 0;
    T2CONbits.TCKPS = 0; //prescaler set to 00 which is 1:1
    //T2CONbits.TGATE = 0;
    T2CONbits.TSIDL = 0;
    ...
    PR2 = (time_ms *4); //pr2 = time_ms * 8Mhz/2 /1000 (for delay in ms)
    //PR2 = (time_ms *32000)/2000; //pr2 = time_ms * 32khz/2 /1000 (for delay in ms)
    TMR2 = 0;
    T2CONbits.TON = 1;
    Idle();
